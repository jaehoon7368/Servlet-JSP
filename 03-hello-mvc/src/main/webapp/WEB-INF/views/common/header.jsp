<%@page import="com.sh.mvc.member.model.dto.MemberRole"%>
...
<body>
	<div id="container">
        ...
        <form 
            ...
            <table>
                <tr>
                    <td><input type="text" name="memberId" id="memberId" placeholder="아이디" tabindex="1" value="<%= saveId != null ? saveId : ""%>" required></td>
